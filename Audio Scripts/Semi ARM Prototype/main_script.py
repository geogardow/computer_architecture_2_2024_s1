...
filtered_array = filter_audio(built_array, SAMPLE_RATE, AUDIO_LENGTH, Nb=16, Nx=16)
#fixed_array = float_array_to_fixed(audio_array, 7, 8)
#array_to_file(fixed_array, "./Audio Scripts/Semi ARM Prototype/audio.txt")
#built_array = fixed_array_to_float(fixed_array, 7, 8)
#print(filtered_array)
array_to_audio(filtered_array, "./Audio Scripts/Semi ARM Prototype/rebuilt.wav",SAMPLE_RATE)
